...
namespace lab3
{
    public partial class Publishers : Form
    {
        ...
        public void AddNew(Publisher newItem)
        {
            ...
            if (existingIndex != -1)
            {
                command.CommandText = "UPDATE Publishers SET workplace = '" + newItem.Place + "', adress = '" + newItem.Address + "', phoneNumber = '" + newItem.PhoneNumber + "' WHERE id = " + newItem.Id;
                items[existingIndex] = newItem;
            }
            else
            {
                command.CommandText = "INSERT INTO Publishers (workplace, adress, phoneNumber) VALUES('" + newItem.Place + "', '" + newItem.Address + "', '" + newItem.PhoneNumber + "'); ";
                items.Add(newItem);
            }
