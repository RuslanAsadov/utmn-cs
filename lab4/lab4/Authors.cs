...
namespace lab3
{
    public partial class Authors : Form
    {
        ...
        public void AddNew(Author newItem)
        {
            ...
            if (existingIndex != -1)
            {
                command.CommandText = "UPDATE Author SET name = '" + newItem.Name + "', birthday = '" + newItem.BirthDate.ToString("dd.MM.yyy H:mm:ss") + "', workplaceId = '" + newItem.WorkplaceId + "', scienceDegreeId = '" + newItem.ScienceDegreeId + "' WHERE id = " + newItem.Id;
                items[existingIndex] = newItem;
            }
            else
            {
                command.CommandText = "INSERT INTO Author (name, birthday, workplaceId, scienceDegreeId) VALUES('" + newItem.Name + "', '" + newItem.BirthDate.ToString("dd.MM.yyy H:mm:ss") + "', '" + newItem.WorkplaceId + "', '" + newItem.ScienceDegreeId + "'); ";
                items.Add(newItem);
            }
